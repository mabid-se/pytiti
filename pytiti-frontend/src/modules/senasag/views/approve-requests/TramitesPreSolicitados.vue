            ...
            <div class="table-responsive table-card">
              ...
              >
                ...
                <template v-slot:row="{ item }">
                  <tr>
                    <td>{{ formatDateDMYYYYHHmm(item.fecha_solicitud) }}</td>
                    <td>
                      <p>{{ item.empresa.razon_social }}</p>
                      <p>{{ item.fid_sucursal.nombre_sucursal }}</p>
                      <p>{{ item.fid_sucursal.iddistrital }}</p>
                    </td>
                    <td>
...
import AccionesLista from "@/modules/senasag/components/solicitudes/presolicitudes/ActionsList.vue";
...
export default {
  name: "TramitesPresolicitadosAdmin",
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          label: "Empresa/Sucursal/Distrital",
          orderKey: "",
          showOrderIcon: false,
        },
        {
