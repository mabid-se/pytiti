                ...
                <div class="card card-border-grey m-0">
                  ...
                  <div class="card-body">
                    <form
                      ...
                      novalidate
                    >
                      <RolesFormUpdate @update-form-data="updateFormData" />
...
import RolesFormUpdate from "@/views/pages/senasag/roles/rol-form-update.vue";
import SuccessModal from "@/components/pytiti/success-modal.vue";
// services
import { getRoleUpdateSiaService } from "@/services/permisos";
  ...
  data() {
    return {
      ...
      modalData: {
        ...
        message: "La solicitud para su registro fue enviada correctamente.",
        buttonText: "Aceptar",
  ...
  methods: {
    ...
    sendForm(e) {
      ...
      if (!e.target.checkValidity()) {
        ...
        getRoleUpdateSiaService(this.$route.params.id, this.formData).then(
          (res) => {
            if (e.target.checkValidity()) {
