...
import { deleteTemplateProcedure } from "@/modules/empresa/services/PlantillaService";
...
export default {
  name: "TramitePlantillaEditarTramitador",
  ...
  methods: {
    ...
    async sendToSenasag() {
      ...
      this.$router.push({ name: "tramitador.lista.tramites.curso" });
    },
