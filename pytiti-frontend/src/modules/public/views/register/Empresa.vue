...
<script>
import EmpresaRegistroForm from "@/modules/public/components/forms/empresa/Datos.vue";
import RepresentanteRegistroForm from "@/modules/public/components/forms/empresa/RepresentanteLegal.vue";

import { registerCompanyAccountRequest } from "@/services/solicitudes";
...
export default {
  ...
  methods: {
    ...
    sendForm() {
      registerCompanyAccountRequest(this.formData, this.currentItem + 1)
        .then(({ ok, errors: e }) => {
          if (!ok) {
