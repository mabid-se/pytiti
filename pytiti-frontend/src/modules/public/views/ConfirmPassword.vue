            ...
            <div class="card mt-4">
              <div class="card-body p-4">
                <div class="text-center mt-2">
                  ...
                  <div class="mb-3">
                    <p class="text-justify text-muted">
                      Debes crear una contraseña que tenga {{ size }} o más
                      caracteres. Debes incluir un número, un caracter especial
                      (es decir, símbolos como $ % ! &) y un alfabeto
                    </p>
                  </div>
                </div>
                <!-- form -->
                <form autocomplete="off" @submit.prevent="sendCredentials">
                  ...
                  <!-- alerts -->
                  <div
                    v-if="error.danger.status"
                    class="box-message alert alert-danger mb-3"
                    role="alert"
                  >
                    <p>{{ error.danger.message }}</p>
                  </div>
                  <div
                    v-if="error.warning.status"
                    class="box-message alert alert-warning mb-3"
                    role="alert"
                  >
                  ...
                  <div class="mb-3 text-center">
                    <button
                      ...
                      disabled
                      class="btn btn-success w-40-perc"
                    >
                      Guardar
                    </button>
                    <button v-else class="btn btn-success w-40-perc">
                      Guardar
                    </button>
                  </div>
                </form>
