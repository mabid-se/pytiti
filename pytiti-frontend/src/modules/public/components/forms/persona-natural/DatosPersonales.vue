<template>
  <div :class="className">
    ...
    <div class="mb-3">
      <label
        for="per_prefijotitulo"
        class="form-label"
        :class="{
          'text-danger': errors.per_prefijotitulo,
        }"
        >Prefijo
      </label>
      <input
        @input="updateChange"
        name="per_prefijotitulo"
        type="text"
        class="form-control"
        :class="{
          'is-invalid': errors.per_prefijotitulo,
        }"
        id="per_prefijotitulo"
        placeholder="Ej. Ing. Sra. Lic. Dra."
      />
      <div class="invalid-feedback" v-if="errors.per_prefijotitulo">
        {{ errors.per_prefijotitulo[0] }}
      </div>
    </div>
