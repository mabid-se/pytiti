  ...
  setup(props, { emit }) {
    ...
    const drawstart = (event) => {
      ...
      emit("update-coordinates", {
        [props.field.key_latitud]: String(latLong[1]),
        [props.field.key_longitud]: String(latLong[0]),
      });
    };
    ...
    const geoLocChange = (loc) => {
      ...
      count.value += 1;
      emit("update-coordinates", {
        [props.field.key_latitud]: String(long.value),
        [props.field.key_longitud]: String(lat.value),
      });
    };
