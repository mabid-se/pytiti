                    ...
                    <div class="flex-grow-1">
                      <div class="row">
                        <div class="col-lg-12">
                          <div
                            class="card"
                            v-for="(form, formIndex) in currentComponent.forms"
                            :key="formIndex"
                            :set="(v = v$.form_data)"
                          >
                              ...
                              <div class="live-preview">
                                <div class="row gy-4 pt-3">
                                  ...
                                  >
                                    ...
                                    <HelpinputField
                                      v-model="form_data[field.entity_field.id]"
                                      :error-vuelidate="
                                        v[field.entity_field.id]?.$errors
                                      "
                                    ...
                                    <RequirementFileField
                                      ...
                                      "
                                      v-if="
                                        field.type_field === 'requirementField'
                                      "
                                      :style="
                                        fieldIndex % 2 === 0
                                          ? 'background:#eeeeee'
                                    ...
                                    <DefaultField
                                      ...
                                      :error-vuelidate="
                                        v[field.entity_field.id]?.$errors
                                      "
                                      v-if="field.type_field === 'defaultField'"
                                      :field="field"
                                      readonly
                                      @update-change="makeChange"
                                    />
                                    ...
                                    <NestedTableField
                                      v-if="field.type_field === 'nestedTable'"
                                      :field="field"
                                      readonly
                                    />
                      ...
                      <div class="card-body pt-0">
                        <div class="live-preview">
                          <component
                            ...
                            v-on="currentComponentPropsAndEvents.handleEvent"
                          >
                          </component>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-3 align-middle pt-2"></div>
...
import {
  getPreviewProcedureTemplate,
  getComponentPreviewProcedureTemplate,
...
export default {
  ...
  methods: {
    async loadTemplate() {
      const { ok, data: res } = await getPreviewProcedureTemplate(
      ...
      console.log(res.fid_tramite);
      console.log(res.steps);
      this.steps = [res.steps[0]];
      console.log(this.template?.plantilla_tramite);
      console.log(this.template?.plantilla_tramite.steps);

      this.components = this.steps[0].components.filter(
        (c) => c.name.toLowerCase() != "finalizar"
      );
      this.title = "TRAMITE: " + res.name;
      console.log(this.$route.params.slug);
      console.log(this.steps[0].components[0].id);
      this.requirements = res.requirements;
      const { ok: ok2, data: res2 } =
        await getComponentPreviewProcedureTemplate(
          this.$route.params.slug,
