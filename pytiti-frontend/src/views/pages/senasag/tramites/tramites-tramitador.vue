                  ...
                  <template v-slot:filters>
                    ...
                    <div class="col-md-3">
                      ...
                      >
                        ...
                        <option value="DERIVADO_A">DERIVADO_A</option>
                          ...
                          >
                            ...
                            >
                              <router-link
                                class="dropdown-item"
                                :to="{
                                  name: 'tramites-plantilla-tramitador-editar',
                                  params: {
...
import { getUserType, userIsCompany, processorId } from "@/services/user";
...
export default {
  ...
  computed: {
    loadOnCourseProcedures() {
      return `tramitador/${this.processorId}/empresa/${localStorage.getItem(
        "selected_company"
      )}/tramites/`;
    },
  },
