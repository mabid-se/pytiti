                ...
                <div class="row justify-content-md-center gy-4 mt-2">
                  <div class="col-xxl-12 col-md-12 col-lg-12">
                    <form @submit="sendForm" class="was-validated">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-1">
                                <label for="distrital_oficina">Unidad:</label>
                            </div>
                            <div class="col-lg">
                                <input required v-model="formData.datos_institucionales.distrital_oficina" type="text" class="form-control" id="distrital_oficina" name="distrital_oficina" placeholder="Unidad asignada" />
                                <div class="invalid-feedback">Por favor ingrese su unidad asignada</div>
                            </div>
                            <div class="col-lg-2">
