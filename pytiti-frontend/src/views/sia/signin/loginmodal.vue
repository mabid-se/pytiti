        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-6 col-xl-6">
              ...
              <div class="card-body">
                ...
                <ul class="nav nav-pills animation-nav nav-justified gap-2 mb-3" role="tablist">
                  <li class="nav-item waves-effect waves-light">
                    <a class="nav-link active" data-bs-toggle="tab" href="#animation-home" role="tab"> Ingresar </a>
                  </li>
                  <li class="nav-item waves-effect waves-light">
                    <a class="nav-link" data-bs-toggle="tab" href="#animation-profile" role="tab"> Solicitar acceso </a>
                  </li>
                </ul>
                <div class="tab-content text-muted">
                  <div class="tab-pane active" id="animation-home" role="tabpanel">
                    <div class="mb-3">
                      ...
                      <div class="form-icon right">
                        <input type="email" class="form-control form-control-icon" id="iconInput" placeholder="Escriba su nombre de usuario asignado">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="form-icon right">
                        <input type="password" class="form-control" id="exampleInputpassword" placeholder="Escriba su contraseña">
                      ...
                      <div class="container">
                        <div class="row">
                          ...
                          <div class="col-6 derecha-verde mt-1">
                            <a href="#" class="text-primary text-decoration-underline"> Olvidé mi contraseña </a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="tab-pane" id="animation-profile" role="tabpanel">
                    <div class="mb-3">
                      <label for="exampleInputpassword" class="form-label">Carnet de identidad</label>
                      <div class="form-icon right">
                        <input class="form-control" placeholder="Escriba su número de carnet">
                      </div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputpassword" class="form-label">Complemento</label>
                      <div class="form-icon right">
                        <input class="form-control" placeholder="Escriba el complemento">
                      </div>
                    </div>
                    <div class="mt-4">
            ...
            <div class="container">
              <div class="row">
                <div class="col-6 mt-0 izquierda">
                  <a href="signup" class="text-primary text-decoration-underline">Validación 1</a>
                </div>
                <div class="col-6 derecha">
                  <a href="#" class="text-primary text-decoration-underline">Validación 2</a>
                </div>
              </div>
            </div>
          </div>
