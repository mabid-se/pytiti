            ...
            <div class="row">
              <div class="col-xxl-12">
                <div class="card">
                  <div class="card-body">
                    <span class="link"
                      >Con este formulario se puede vincular un documento de
                      Liquidación o de Multa previamente generado a través del
                      <a
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active" id="liq" role="tabpanel">
                        <div class="d-flex">
                          <div class="flex-grow-1 ms-2">
                            ...
                            <div class="row">
                              <div class="col-lg-10">
                                ...
                                <div class="col-8" v-if="this
                                    .serviciosInfoArray.length">
                                  <label for="formFile" class="form-label"
                                    >Escriba el código de liquidación para
                                    vincular la liquidación al trámite</label
                                  >
                                  <div
                            ...
                            >
                              <div
                                class="col-12"
                                v-if="mensaje !== this.errorMessage"
                              >
                                <div class="row">
                                  <div class="col-xxl-4"></div>
                                  <!-- end col -->
                            ...
                            <div class="row" v-if="this.respuestaObject">
                              <div class="col-12" v-if="!liquidacionVinculada">
                                <div class="row">
                                  <div class="col-xxl-4"></div>
                                  <!-- end col -->
                                  <div class="col-xxl-4">
                                    <h6 class="card-title mb-3 text-center">
                                      <span
                                        class="badge bg-success align-middle fs-14"
                                        >Registro obtenido con éxito</span
                                      >
                                    </h6>
                                    <div
                                        ...
                                        <div class="row g-3 mb-3">
                                          ...
                                          <div class="col-lg-12 mt-menor">
                                            ...
                                            ><span
                                              class="text-muted ml-1 mb-0"
                                              >{{
                                                this.respuestaObject.empresaNit
                                              }}</span
                                            >
                                          </div>
                                          <div class="col-lg-12 mt-menor">
                                            ...
                                            ><span
                                              class="text-muted ml-1 mb-0"
                                              >{{
                                                this.respuestaObject.totalCosto
                                              }}</span
                                            >
                                          </div>
                                          <hr />
                                          <div
                                            v-for="(servicio, index) of this
                                              .respuestaObject.datosServicio"
                                            :key="index"
                                          >
                                            <div class="col-lg-12 mt-menor">
                                              <label
                              ...
                              >
                                <label for="formFile" class="form-label"
                                  >Adjuntar archivo de liquidación</label
                                >
                                <input
                                  @change="updateChange"
                                  class="form-control"
                              ...
                              <div class="row" v-if="liquidacionVinculada">
                                <div class="col-lg-12">
                                  <div class="card">
                                    <div class="card-body">
                                              ...
                                              >
                                                <thead>
                                                  <tr>
                                                    ...
                                                    <th scope="col">Costo Liquidación</th>
                                                  </tr>
                                                </thead>
                                                <tbody>
                                                  <tr
                                                  ...
                                                  >
                                                    ...
                                                    <td>
                                                      <a
                                                        :href="this.documentoAdjunto?documentoAdjunto:`#`" target="_blank"
                                                        data-toggle="tooltip"
                              ...
                              <div
                                class="row text-center"
                                style="display: block"
                                v-if="liquidacionVinculada || ejecutado"
                              >
                                <div
                                  class="d-flex- flex-wrap gap-2 mb-3 mb-lg-0"
                                >
                                  ...
                                  <div
                                    class="modal modal-liquidacion fade bs-example-modal-center"
                                    tabindex="-1"
                                    role="dialog"
                                        ...
                                        <div class="modal-body text-center p-5">
                                          ...
                                          <div class="mt-4">
                                            ...
                                            <p class="text-muted mb-4">
                                              La liquidación está lista para ser
                                              consumida.
                                            </p>
                                            <div
                          ...
                          <div class="flex-grow-1 ms-2">
                            ...
                            <div class="row">
                              <div class="col-12">
                                <div class="col-12">
                                  <label for="formFile" class="form-label"
                                    >Elija el tipo de parámetro y escriba el
                                    valor</label
                                  >
                                  <div class="row">
                                    <div class="col-lg-3">
                                      <select
                                        ...
                                        v-model="tipoParametro"
                                      >
                                        <option selected disabled>
                                          -Parámetro-
                                        </option>
                                        <option value="nroMulta">
                                          Nro. de Multa
                                        </option>
                                        <option value="nroActa">
                                          Nro. Acta o Resolución Sancionatoria
                                        </option>
                                      </select>
                                    </div>
                                    <div class="col-lg-4">
                                      ...
                                      <p>
                                        Escriba el valor para vincular la multa
                                        al trámite
                                      </p>
                                    </div>
                                    <div class="col-lg-5">
                            ...
                            <div
                              class="row"
                              v-if="mensajeMulta !== errorMessageMulta"
                            >
                              <div class="col-12">
                                <div class="row">
                                  <div class="col-xxl-4"></div>
                            ...
                            <div class="row" v-if="messageMulta !== ''">
                              <div class="col-12">
                                <div class="row">
                                  <div class="col-xxl-4"></div>
                                  <!-- end col -->
                            ...
                            <div class="row" v-if="this.multaObject">
                              <div class="col-12" v-if="!multaVinculada">
                                <div class="row">
                                  <div class="col-xxl-4"></div>
                                  <!-- end col -->
                                  <div class="col-xxl-4">
                                      ...
                                      <div class="card-body">
                                        ...
                                        <div class="">
                                          <label
                                            for="formFile"
                                            class="form-label"
                                            >Adjuntar archivo de multa</label
                                          >
                                          <input
                                            class="form-control"
                                            type="file"
                              ...
                              <div
                                class="row text-center"
                                v-if="!existeMulta || !multaVinculada"
                              >
                                <div
                                  class="d-flex- flex-wrap gap-2 mb-3 mb-lg-0"
                                >
                              ...
                              <div class="row" v-if="multaVinculada">
                                <div class="col-lg-12">
                                  <div class="card">
                                    <div class="card-body">
                                      <div class="live-preview">
...
export default {
  ...
  data() {
    return {
      ...
      empresas: [
        {
          text: "Empresa prueba 1",
          value: "c6971ba4-a970-402d-8762-32bf0ec58e7d",
        },
        {
          text: "Empresa prueba 2",
          value: "c746433e-4b97-409c-abee-29a423cbc59a",
        },
        {
          text: "Empresa prueba 3",
          value: "2604436e-a330-40f9-8edc-6fb64297a8ba",
        },
        {
          text: "Empresa prueba 4",
          value: "9ea73b9c-3024-40f8-ac0d-a5072a1c03fc",
        },
        {
          text: "Empresa prueba 5",
          value: "d1a679bd-2da2-43e9-9572-1d6037afd2b5",
        },
        {
          text: "Empresa prueba 6",
          value: "4c5cb5f1-1295-43e0-99b9-95c17b96b8c1",
        },
        {
          text: "Empresa prueba 7",
          value: "15b555d5-2315-4712-931d-2b86d748a327",
        },
      ],
      serviciosInfoArray: [],
  ...
  methods: {
    async changeTab (tab) {
      ...
      this.tab = tab;
      if(tab==="multa"){
        const {data:multas} = await getMultas(this.solicitudTramiteInfo.id_solicitud_tramite)
        if(!multas.mensaje){
          multas.forEach(item=>{
          const servicios=item.datosServicios.map(serv=>({...serv,fechaActa:item.fechaActa,fechaPago:item.fechaPago,pago:item.pago}))
          this.multasInfo.push(...servicios)
        })
        }
    ...
    async hideModal() {
      ...
      this.closeModal()
      NotificationHelper.success("Se consumió los servicios correctamente.");
    },
    closeModal(){
    ...
    async hasLiquidation(value) {
      ...
      if (!hasLiquidation.mensaje) {
        ...
        const liquidacionInfo = await checkLiquidation(
          hasLiquidation.nroliquidacion
        );
        ...
        if (res.finalizado && res.datos.pago) {
          ...
          await uploadLiquidation(
            liquidacionInfo.id_liquidacion,
            liquidacionPayload
          );
        }
        if (!res.finalizado) {
        ...
        const liquidacion = await checkLiquidation(
          hasLiquidation.nroliquidacion
        );
    ...
    async sendRequest() {
      ...
      if (res.finalizado && res.datos.pago) {
        if(this.existeLiquidacionObject.ejecutado && this.existeLiquidacionObject.pago){
            this.errorMessage ="Este Nro de Liquidación ya fue Utilizado"
            return
        }
        this.message = "Liquidación pagada lista para consumir";
    ...
    async vincularCobro() {
      const nitOrCi=this.solicitudTramiteInfo.fid_empresa.nit || this.solicitudTramiteInfo.fid_empresa.fid_persona_propietario?.idcarnet
      
      if(nitOrCi && nitOrCi!==this.respuestaObject.empresaNit){
        alert("No coincide el nit de la empresa")
        return
      }
      if(this.solicitudTramiteInfo.fid_empresa.razon_social !==this.respuestaObject.empresaRazonSocial){
        alert("No coincide la razon social de la empresa")
        return
      }
      ...
      NotificationHelper.success("La vinculacion se guardo correctamente.");
      await this.sendRequest();
    },
    async vincularMulta() {
      const nitOrCi=this.empresaInfo.data.fid_empresa.nit || this.empresaInfo.data.fid_empresa.fid_persona_propietario?.idcarnet
      if(nitOrCi && nitOrCi!==this.multaObject.empresaNit){
        alert("No coincide el nit de la empresa")
        return
      }
      if(this.solicitudTramiteInfo.fid_empresa.razon_social !==this.multaObject.empresaRazonSocial){
        alert("No coincide la razon social de la empresa")
        return
      }
      if (!this.existeMulta) {
      ...
      if (!this.multaVinculada) {
        await linkMultas(
          ...
          this.valor,
          this.carnetIdentidad,
          this.empresaInfo.data?.id_solicitud_tramite
        );
    ...
    async liquidacionSiExiste() {
      ...
      this.existeLiquidacion = !(
        liquidacion.mensaje === "La liquidacion no existe"
      );
      if (this.existeLiquidacion) {
        const { nroliquidacion, datosServicios, fechadeposito, ...rest } =
          liquidacion;
        this.existeLiquidacionObject = {
    ...
    async multaSiExiste() {
      ...
      const multa = await checkMulta(
        this.tipoParametro,
        this.valor,
        this.carnetIdentidad
      );
      this.multaVinculada = !(
        vinculacion.mensaje === "La multa no esta vinculada"
      );
    ...
    async verificarServicios() {
      const servicios = this.serviciosInfoArray.map(
        (servicio) => +servicio.codigoservicio
      );
      if(this.respuestaObject){
    ...
    async sendFormMulta() {
      try {
        const { datosPago, datosServicio, fechaActa,fechaPago, ...rest } =
          this.multaObject;
        const payload = {
          ...rest,
    ...
    async actualizarMulta() {
      ...
      promises.push(
        await uploadLiquidation(
          this.existeMultaObject.id_liquidacion,
          liquidacionPayload
        )
      );
    ...
    async consumirServicio() {
      ...
      servicios.map(async (servicio) => {
        const datoServicio = this.respuestaObject.datosServicio.find(
          (datoServicio) =>
            datoServicio && +datoServicio.codigoServicio === servicio
        );
        const payload = {
      ...
      promises.push(
        await uploadLiquidation(
          this.respuestaObject.id_liquidacion,
          liquidacionPayload
        )
      );
      promises.push(await registerDeposit(depositoPayload));
    ...
    async liberarServicio() {
      ...
      await Promise.all(promises);
      NotificationHelper.success("Se liberó los servicios correctamente.");
      await this.sendRequest();
    },
    async liberarMulta() {
      const promises = [];
    ...
    currentDateMulta() {
      const given = moment(this.multaObject.fechaActa, "YYYY-MM-DD");
      const current = moment().startOf("day");
      const diff = moment.duration(current.diff(given)).asDays();
      return this.multaObject.fechaPago
        ? this.formatDate(this.multaObject.fechaPago)
        : `${diff} día(s) - Pago pendiente`;
    },
  ...
  async beforeMount() {
    ...
    if (this.$route.params.id_solicitud_tramite) {
      ...
      const sucursal = await getInfo( this.$route.params.id_solicitud_tramite)
      this.empresaInfo = sucursal
      
      const solicitudTramite = this.empresaInfo.data;
      this.solicitudTramiteInfo = this.empresaInfo.data;
      if (solicitudTramite.nroliquidacion) {
        this.liquidacionVinculada = true;
        this.existeLiquidacion = true;
        this.nroLiquidacion = solicitudTramite.nroliquidacion;
        liquidacionInfo = await checkLiquidation(
          solicitudTramite.nroliquidacion
        );
        if(liquidacionInfo && liquidacionInfo.documentos.length){
          this.documentoAdjunto = liquidacionInfo.documentos[0].fid_documento.ruta_url
        }
        const res =
          this.tab === "liquidacion"
        ...
        if (res.finalizado && res.datos.pago) {
          if(liquidacionInfo.ejecutado && liquidacionInfo.pago){
            this.errorMessage ="Este Nro de Liquidación ya fue Utilizado"
            const {datosServicios,...rest} =liquidacionInfo
            this.respuestaObject = {
              ...rest,
              ...res.datos,
              datosServicio: datosServicios,
          ...
          liquidacionInfo={...liquidacionInfo,...liquidacionPayload}
          uploadLiquidation(
            liquidacionInfo.id_liquidacion,
            liquidacionPayload
          );
        ...
        const { datosServicios, ...rest } = liquidacion;*/
        const {datosServicios,...rest} =liquidacionInfo
        this.respuestaObject = {
          ...rest,
          ...res.datos,
