  ...
  <form class="card" novalidate="true" @submit.prevent="onSubmit">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Grupos de documentos de ayuda</h4>
    ...
    >
      <DocumentFormModal
        ...
        @on:update:document="updateRequirement"
        @on:create:document="newRequirement"
        @on:close:modal="closeModal"
      ></DocumentFormModal>
    </Modal>
  </form>
...
import DocumentFormModal from "@/components/tramites/forms/document-form-modal.vue";
